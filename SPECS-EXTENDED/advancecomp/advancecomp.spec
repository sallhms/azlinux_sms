...
* Wed Dec 11 2024 Benjamin A. Beasley <code@musicinmybrain.net> - 2.6-8
- Add a SourceLicense field

* Wed Dec 11 2024 Benjamin A. Beasley <code@musicinmybrain.net> - 2.6-7
- Improve the license-breakdown spec-file comment

* Thu Oct 31 2024 Benjamin A. Beasley <code@musicinmybrain.net> - 2.6-6
- Invoke autoreconf and configure in %%conf rather than in %%build

* Wed Jul 17 2024 Fedora Release Engineering <releng@fedoraproject.org> - 2.6-5
- Rebuilt for https://fedoraproject.org/wiki/Fedora_41_Mass_Rebuild

* Mon Jan 22 2024 Fedora Release Engineering <releng@fedoraproject.org> - 2.6-3
- Rebuilt for https://fedoraproject.org/wiki/Fedora_40_Mass_Rebuild

* Fri Jan 19 2024 Fedora Release Engineering <releng@fedoraproject.org> - 2.6-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_40_Mass_Rebuild

* Thu Nov 09 2023 Benjamin A. Beasley <code@musicinmybrain.net> - 2.6-1
- Update to 2.6 (close RHBZ#2243085)

* Wed Jul 19 2023 Fedora Release Engineering <releng@fedoraproject.org> - 2.5-7
- Rebuilt for https://fedoraproject.org/wiki/Fedora_39_Mass_Rebuild

* Sat Jun 03 2023 Benjamin A. Beasley <code@musicinmybrain.net> - 2.5-6
- Remove explicit %%set_build_flags, not needed since F36

* Thu May 11 2023 Benjamin A. Beasley <code@musicinmybrain.net> - 2.5-2
- Add an rpmlintrc file

* Sun Jan 22 2023 Benjamin A. Beasley <code@musicinmybrain.net> - 2.5-1
- Update to 2.5 (close RHBZ#2162990; fix RHBZ#2161641)

* Wed Jan 18 2023 Fedora Release Engineering <releng@fedoraproject.org> - 2.4-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_38_Mass_Rebuild

* Wed Nov 23 2022 Benjamin A. Beasley <code@musicinmybrain.net> - 2.4-1
...
* Thu Sep 29 2022 Benjamin A. Beasley <code@musicinmybrain.net> - 2.3-5
- Identify bundled 7-Zip as “7zip” rather than “7z”

* Thu Sep 29 2022 Benjamin A. Beasley <code@musicinmybrain.net> - 2.3-4
- Add a comment about upstream tests

* Wed Sep 28 2022 Benjamin A. Beasley <code@musicinmybrain.net> - 2.3-3
- Stricter file globs
...
* Wed Sep 28 2022 Benjamin A. Beasley <code@musicinmybrain.net> - 2.1-30
