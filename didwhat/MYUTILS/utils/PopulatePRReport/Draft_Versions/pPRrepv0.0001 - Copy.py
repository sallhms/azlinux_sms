...
def pick_evaluator():
    ...
    workbook_ExtPkgs = 'C:\\Users\\v-nsallh\\Utils\\PopulatePRReport\\ExtendedPackages_wSuppInfo.xlsx'
    wb_ExtPkgs = openpyxl.load_workbook(workbook)  
    ws_ExtPkgs = wb.active

    #workbook_Jyoti = 'C:\\Users\\v-nsallh\\OneDrive - Microsoft\\Documents\\Work\\PackageUpgrades-3.0\\PackageUpgradeReport-Jyoti.xlsx'
    workbook_Jyoti = 'C:\\Users\\v-nsallh\\Utils\\PopulatePRReport\\PackageUpgradeReport-Jyoti.xlsx'
    wb_Jyoti = openpyxl.load_workbook(workbook)  
    ws_Jyoti = wb.active
    # Iterate over rows and delete based on a condition
...
#Neeraj    cleanup_xl_sheet()
#Neeraj    print('Now Processing: read_all_pkg_names. Please wait.........')
#Neeraj    logger.info('Now Processing: read_all_pkg_names. Please wait.........')
