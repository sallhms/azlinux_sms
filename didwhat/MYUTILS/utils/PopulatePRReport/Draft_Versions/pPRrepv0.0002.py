...
#    workbook_Akarsh = 'C:\\Users\\v-nsallh\\OneDrive - Microsoft\\Documents\\Work\\PackageUpgrades-3.0\\PackageUpgradeReport-Akarsh.xlsx'
    workbook_Akarsh = 'C:\\Users\\v-nsallh\\OneDrive - Microsoft\\Documents\\Work\\PackageUpgrades-3.0\\PackageUpgradeReport-Akarsh_fast.xlsx'
#    workbook_Akarsh = 'C:\\Users\\v-nsallh\\Utils\\PopulatePRReport\\PackageUpgradeReport-Akarsh.xlsx'
#    workbook_Akarsh = 'C:\\Users\\v-nsallh\\Utils\\PopulatePRReport\\New Microsoft Excel Worksheet.xlsx'
...
#                print (f' row num = {importws_rnum}, package = {pkgnm_fromimp} evaluator = {evaluator_fromimp} PR = {prlink_fromimp}')
        ...
        if ( found_flag != 1):
            ...
            ws_CSLDTD_rep.cell(row=rnum+2, column=2).value=rnum;
            ws_CSLDTD_rep.cell(row=rnum+2, column=3).value=pkgname;
            ws_CSLDTD_rep.cell(row=rnum+2, column=4).value=row[4];
            ws_CSLDTD_rep.cell(row=rnum+2, column=5).value=row[5];
            ws_CSLDTD_rep.cell(row=rnum+2, column=6).value=row[6];
            ws_CSLDTD_rep.cell(row=rnum+2, column=7).value=row[7];
            ws_CSLDTD_rep.cell(row=rnum+2, column=8).value=f'NOT_FOUND';
            ws_CSLDTD_rep.cell(row=rnum+2, column=9).value=row[9];
            ws_CSLDTD_rep.cell(row=rnum+2, column=10).value=row[10];
            ws_CSLDTD_rep.cell(row=rnum+2, column=11).value=row[11];
            ws_CSLDTD_rep.cell(row=rnum+2, column=12).value=row[12];
            ws_CSLDTD_rep.cell(row=rnum+2, column=13).value=row[13];
            ws_CSLDTD_rep.cell(row=rnum+2, column=14).value=row[14];
            ws_CSLDTD_rep.cell(row=rnum+2, column=15).value=row[15];
            ws_CSLDTD_rep.cell(row=rnum+2, column=16).value=row[16];
            ws_CSLDTD_rep.cell(row=rnum+2, column=17).value=row[17];
            ws_CSLDTD_rep.cell(row=rnum+2, column=18).value=row[18];
            ws_CSLDTD_rep.cell(row=rnum+2, column=19).value=row[19];
            ws_CSLDTD_rep.cell(row=rnum+2, column=20).value=row[20];
            ws_CSLDTD_rep.cell(row=rnum+2, column=21).value=row[21];

    #we can write to the two files in the very end after having prepared the things
